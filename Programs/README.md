...
| --- | --- |
| Tests | Project passes the tests:<br> :heavy_check_mark: You've addressed the Program Requirements (all requirements necessary to pass both the provided and hidden tests).<br> :heavy_check_mark: Project produces output that matches the expected standard output, standard error output, and exit status.<br> :heavy_check_mark: Project submitted to INGInious; successfully compiles. |
